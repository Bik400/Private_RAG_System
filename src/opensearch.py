...
def get_opensearch_client() -> OpenSearch:
    ...
    Returns:
        OpenSearch: A configured OpenSearch client instance
    """
...
def hybrid_search(query_text: str, query_embedding: List[float], top_k: int = 5) -> List[Dict[str, Any]]:
    ...
    Args:
        ...
        top_k (int) -> Number of topr results to retrieve. Defaults to 5
    ...
    # Type casting for compatability with expected return type
